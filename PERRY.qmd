...
students |>
  ...
  labs(
    title = "Number of Students per Group and Sex",
    x = "Group",
    y = "Number of Students",
    fill = "Sex"
  )
...
grades |>
  ...
  geom_col()+ 
  labs(
    title = "Average Grade in Combat by Group",
    x = "Group",
    y = "Average Grade in Combat"
  )
```
...
avg_per_course |>
  ...
  labs(
    title = paste("Correlation Between Greek Mythology and Music & Poetry in Group", best_group),
    x = "Grade in Greek Mythology and Folklore",
    y = "Grade in Music and Poetry"
  )
```
